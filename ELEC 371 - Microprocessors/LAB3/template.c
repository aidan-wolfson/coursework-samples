...
void interrupt_handler(void)
{
	...
	if (ipending & (1 << 14)){ // timer 1
		*(T1_STATUS) = 0;
		if(*SEVENSEG == 0x70707070){
			*SEVENSEG = 0x46464646;
		} else if (*SEVENSEG == 0x46464646){
			*SEVENSEG = 0x70707070;
		}
	}
...
void Init (void)
{
	...
	*PUSHBUTTONS_MASK = 6;
	...
	NIOS2_WRITE_IENABLE((1 << 14) + (1 << 13) + 0x1);
...
int main (void)
{
	...
	volatile unsigned int switchSettings;
